...
End to end retail sales analysis and forecasting project, using **R** for the data preparation and modeling and **Power BI** for the interactive dashboard and insights.
